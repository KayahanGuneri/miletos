...
export function GenericExecutionNode({
  data,
  selected,
}: NodeProps<ExecutionGraphNode>) {
  const runtimeStatus = data.runtimeStatus;

  return (
    <article
      className={[
        styles.genericExecutionNode,
        selected ? styles.genericExecutionNodeSelected : "",
      ]
        .filter(Boolean)
        .join(" ")}
    ...
    >
      ...
      <header className={styles.genericExecutionNode__header}>
        <span className={styles.genericExecutionNode__type}>
          {data.pluginType}
        </span>
        ...
        {runtimeStatus ? (
          ...
          <span className={styles.genericExecutionNode__statusMuted}>
            Definition
          </span>
        )}
      </header>
