...
public class WorkflowRuntimeGrpcClient {
    ...
    public WorkflowRuntimeResponse getPlugins(
        ...
        return invoke(
                ...
                browserHeaders,
                HttpStatus.OK,
                stub -> PluginServiceGrpc.newBlockingStub(stub)
                        .listPlugins(Empty.getDefaultInstance()));
    }
    ...
    public WorkflowRuntimeResponse executeSync(
        ...
        return invoke(
                ...
                browserHeaders,
                HttpStatus.OK,
                stub -> ExecutionServiceGrpc.newBlockingStub(stub)
                        .executeSync(jsonMapper.toExecuteRequest(body)));
    }
    ...
    public WorkflowRuntimeResponse executeAsync(
        ...
        return invoke(
                ...
                HttpStatus.ACCEPTED,
                stub -> ExecutionServiceGrpc.newBlockingStub(stub)
                        .executeAsync(jsonMapper.toExecuteRequest(body)));
    }
    ...
    public WorkflowRuntimeResponse recoverExecution(
        ...
        return invoke(
                ...
                HttpStatus.ACCEPTED,
                stub -> ExecutionServiceGrpc.newBlockingStub(stub)
                        .recoverExecution(RecoverExecutionRequest.newBuilder()
    ...
    public WorkflowRuntimeResponse listExecutions(
            ...
            String companyId,
            HttpHeaders browserHeaders) {
        ListExecutionsRequest.Builder request = ListExecutionsRequest.newBuilder()
                .setWorkflowId(first(query, "workflowId"))
                .setStatus(first(query, "status"))
                .setCursor(first(query, "after"))
    ...
    public WorkflowRuntimeResponse getExecution(
        ...
        return invoke(
                ...
                HttpStatus.OK,
                stub -> ExecutionServiceGrpc.newBlockingStub(stub)
                        .getExecution(executionRequest(executionId)));
    }
    ...
    public WorkflowRuntimeResponse createHTTPTrigger(
        ...
        if (body == null || !body.isObject()) {
            return localError(HttpStatus.BAD_REQUEST, "INVALID_HTTP_TRIGGER_REQUEST",
                    "HTTP trigger request must be a JSON object.", browserHeaders);
        }
        CreateHTTPTriggerRequest request;
        try {
            request = CreateHTTPTriggerRequest.newBuilder()
                    .setDefinition(jsonMapper.toWorkflowDefinition(body.get("definition")))
        ...
        return invoke(
                ...
                browserHeaders,
                HttpStatus.CREATED,
                stub -> HTTPTriggerServiceGrpc.newBlockingStub(stub)
                        .createHTTPTrigger(request));
    }
    ...
    public WorkflowRuntimeResponse getHTTPTrigger(
        ...
        return invoke(
                ...
                HttpStatus.OK,
                stub -> HTTPTriggerServiceGrpc.newBlockingStub(stub)
                        .getHTTPTrigger(GetHTTPTriggerRequest.newBuilder()
    ...
    public WorkflowRuntimeResponse disableHTTPTrigger(
        ...
        return invoke(
                ...
                HttpStatus.OK,
                stub -> HTTPTriggerServiceGrpc.newBlockingStub(stub)
                        .disableHTTPTrigger(DisableHTTPTriggerRequest.newBuilder()
                                .setTriggerId(triggerId)
                                .build()));
    }

    private <T extends com.google.protobuf.Message> WorkflowRuntimeResponse invoke(
            String companyId,
            HttpHeaders browserHeaders,
        ...
        try {
            ...
            return response(successStatus, jsonMapper.toBrowserJson(response), browserHeaders);
    ...
    private WorkflowRuntimeResponse mapError(
        ...
        ObjectNode body = errorBody(
                status,
                code,
                safeMessage(status, code),
                browserHeaders);
        if (!details.isEmpty()) {
    ...
    private HttpStatus httpStatus(io.grpc.Status.Code code, String reason) {
        return switch (code) {
            case INVALID_ARGUMENT -> "WORKFLOW_VALIDATION_FAILED".equals(reason)
    ...
    private WorkflowRuntimeResponse localError(
        ...
        return response(
                status,
                write(errorBody(status, code, message, browserHeaders)),
                browserHeaders);
    }
    ...
    private ListExecutionResourceRequest resourceRequest(
            String executionId,
            MultiValueMap<String, String> query) {
    ...
    private int limit(MultiValueMap<String, String> query) {
        String value = first(query, "limit");
        if (value.isBlank()) {
            return 0;
        }
        try {
