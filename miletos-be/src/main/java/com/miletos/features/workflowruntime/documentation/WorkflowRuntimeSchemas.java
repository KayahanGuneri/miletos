...
public final class WorkflowRuntimeSchemas {
    ...
    public record ExecutionPage(
            List<ExecutionSummaryResponse> items,
            String next,
            boolean hasNext) {
    }
    ...
    public record NodeExecutionPage(
            List<NodeExecution> items,
            String next,
            boolean hasNext) {
    }
    ...
    public record ExecutionEventPage(
            List<ExecutionEvent> items,
            String next,
            boolean hasNext) {
    }
    ...
    public record ExecutionErrorPage(
            List<ExecutionError> items,
            String next,
            boolean hasNext) {
    }
