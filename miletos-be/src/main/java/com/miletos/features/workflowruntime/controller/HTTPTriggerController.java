...
@RestController
@RequestMapping(value = "/api/v1/http-triggers", produces = MediaType.APPLICATION_JSON_VALUE)
...
public class HTTPTriggerController {
  ...
  @Operation(
      ...
      description =
          "Creates an immutable ASYNC HTTP webhook binding from a persisted workflow. "
  ...
  @io.swagger.v3.oas.annotations.parameters.RequestBody(
      ...
      content =
          @Content(
              ...
              schema = @Schema(implementation = LegacyCreateHTTPTriggerRequest.class)))
  @ApiResponses({
    @ApiResponse(
        responseCode = "201",
        content =
            @Content(
                ...
                schema =
                    @Schema(
                        implementation = WorkflowRuntimeSchemas.CreateHTTPTriggerResponse.class)))
  })
    ...
    @ApiResponse(
        ...
        content =
            @Content(
                mediaType = "application/json",
                schema =
                    @Schema(implementation = WorkflowRuntimeSchemas.HTTPTriggerResponse.class)))
  })
  public ResponseEntity<byte[]> get(
      @CurrentUser User user,
      @PathVariable String triggerId,
      @RequestHeader HttpHeaders browserHeaders) {
    return toResponseEntity(workflowRuntimeService.getHTTPTrigger(user, triggerId, browserHeaders));
  }
  ...
  public ResponseEntity<byte[]> disable(
      ...
      @RequestHeader HttpHeaders browserHeaders) {
    return toResponseEntity(
        workflowRuntimeService.disableHTTPTrigger(user, triggerId, browserHeaders));
  }
