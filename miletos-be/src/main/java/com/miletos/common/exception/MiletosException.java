...
public abstract class MiletosException extends RuntimeException {
  ...
  protected MiletosException(ErrorCode code, HttpStatus httpStatus) {
    this(code, httpStatus, Map.of(), null);
  }

  protected MiletosException(ErrorCode code, HttpStatus httpStatus, Throwable cause) {
    this(code, httpStatus, Map.of(), cause);
  }

  protected MiletosException(
      ErrorCode code, HttpStatus httpStatus, Map<String, String> fieldErrors, Throwable cause) {
