...
func TopologicalOrder(workflow model.Workflow) ([]string, error) {
...
func Predecessors(workflow model.Workflow, nodeID string) []string {
...
func Downstream(workflow model.Workflow, startingNodeIDs []string) map[string]bool {
...
func FindCyclePath(workflow model.Workflow) []string {
	outgoing := make(map[string][]string, len(workflow.Nodes))
